                ...
                return `
                    <div class="relative">
                        ...
                        <input 
                            ...
                            class="search-input w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:border-blue-500 focus:outline-none transition-all"
                        />
                    </div>
                `;
            case 'stats':
